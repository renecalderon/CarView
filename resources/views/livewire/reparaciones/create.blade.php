    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Crear Orden de Servicio</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="tab-content" id="custom-tabs-tabContent">
                                <div class="tab-pane fade show active" id="custom-tabs-reparacion" role="tabpanel" aria-labelledby="custom-tabs-reparacion-tab" wire:ignore.self>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-cliente" role="tabpanel" aria-labelledby="custom-tabs-cliente-tab" wire:ignore.self>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-vehiculo" role="tabpanel" aria-labelledby="custom-tabs-vehiculo-tab" wire:ignore.self>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" wire:click.prevent="store()" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-save"></i> Guardar</button>
                    </div>
                </div>
